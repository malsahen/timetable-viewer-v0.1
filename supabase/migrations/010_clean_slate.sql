-- Migration: Seed Teacher Mapping (Clean Slate)
...
-- 3. Delete ALL mappings for the current teacher version to ensure clean slate
-- This avoids unique constraint violations on (version_id, kind, page_no) or (version_id, kind, owner_slug)
